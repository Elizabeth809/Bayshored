        ...
        <div className="relative h-60 bg-neutral-100 overflow-hidden">
          <Link to={`/product/${product.slug}`} className="block w-full h-full">
            ...
            <motion.img
              ...
              className={`w-full h-full object-contain transition-opacity duration-300 !p-4 rounded-xl ${
          ...
          {/* Action Icons - Always visible but with hover effects */}
          <div className="absolute top-4 right-4 z-10 flex flex-col !space-y-3">
            ...
            <motion.button
              ...
              className="!p-3 bg-white/90 backdrop-blur-sm rounded-full shadow-lg hover:bg-white hover:shadow-xl transition-all duration-200 disabled:opacity-50"
            ...
            <motion.button
              ...
              className="!p-3 bg-white/90 backdrop-blur-sm rounded-full shadow-lg hover:bg-white hover:shadow-xl transition-all duration-200"
              title="Quick View"
            >
            ...
            <motion.button
              ...
              className={`!p-3 bg-white/90 backdrop-blur-sm rounded-full shadow-lg transition-all duration-200 ${
                isSoldOut 
                  ? 'cursor-not-allowed' 
                  : 'hover:bg-white hover:shadow-xl disabled:opacity-50'
              }`}
                  ...
                  <div className="flex flex-col font-playfair">
                    ...
                    <div className="flex !space-x-3 !mt-auto">
                      <button
                        ...
                        disabled={addingToCart || isSoldOut}
                        className="flex-1 bg-emerald-600 text-white !py-3 rounded-xl hover:bg-emerald-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition-all duration-200 font-semibold flex items-center justify-center !space-x-2 cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="!px-4 border border-gray-300 rounded-xl hover:bg-gray-50 disabled:opacity-50 transition-colors flex items-center justify-center cursor-pointer"
                        title={isWishlisted ? "Remove from Wishlist" : "Add to Wishlist"}
                      >
                        {addingToWishlist ? (
                          <LoadingSpinner size="small" />
