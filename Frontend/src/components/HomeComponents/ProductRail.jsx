            ...
            >
              <div className="flex items-center gap-2">
                <motion.button
                  ...
                  className="w-12 h-12 border border-gray-900/20 flex items-center justify-center hover:border-gray-900 hover:bg-gray-900 group transition-all duration-300 cursor-pointer"
                >
